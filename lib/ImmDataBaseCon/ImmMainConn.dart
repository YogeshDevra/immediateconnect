// ignore_for_file: import_of_legacy_library_into_null_safe, prefer_const_declarations, depend_on_referenced_packages, file_names
...
class ImmMainConn {
  static final _databaseName = "ImmMainDataCon";
  ...
  ImmMainConn._privateConstructor();
  static final ImmMainConn mainInst = ImmMainConn._privateConstructor();
  ...
  Future<int> insert(Map<String, dynamic> row) async {
    Database db = await mainInst.database;
