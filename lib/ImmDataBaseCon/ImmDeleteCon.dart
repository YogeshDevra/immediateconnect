// ignore_for_file: import_of_legacy_library_into_null_safe, depend_on_referenced_packages, prefer_const_declarations, file_names, non_constant_identifier_names
...
class ImmDeleteCon {
  static final _databaseName = "ImmDelete.DB";
  ...
  static final columnTotalValue = 'delete_total_value';
  static final columnDateTime = 'date_time';

  // make this a singleton class
  ImmDeleteCon._privateConstructor();
  static final ImmDeleteCon deleteInst =
  ImmDeleteCon._privateConstructor();
  ...
  Future<int> insert(Map<String, dynamic> row) async {
    Database db = await deleteInst.database;
