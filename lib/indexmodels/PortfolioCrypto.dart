...
class PortfolioCrypto {
  ...
  PortfolioCrypto(this._id, this._name, this._rate, this._perRate, this._rateDuringAdding,
  ...
  PortfolioCrypto.map(dynamic obj) {
    _id = obj['id'];
    _name=obj['name'] ;
    _rate =  obj['rate'];
  ...
  PortfolioCrypto.fromMap(Map<String, dynamic> map) {
    _id = map['id'];
    _name=map['name'] ;
    _rate =  map['rate'];
