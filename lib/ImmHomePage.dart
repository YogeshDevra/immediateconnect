                                ...
                                children: [
                                  ...
                                  Padding(padding: EdgeInsets.only(left: 20,top: 35),
                                    child:Align(alignment: Alignment.centerLeft,
                                        child:double.parse(ImmcryptoList[i].differRate!) >=0 ?
                                        Text("${double.parse(ImmcryptoList[i].differRate!).toStringAsFixed(2)} %", style:GoogleFonts.openSans(textStyle:TextStyle(
