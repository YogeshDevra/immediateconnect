...
class immediateConnectDatabase {
  static final _databaseName = "MyDatabase.db";
  static final _databaseVersion = 1;
  static final table = 'my_table';
  static final columnId = '_id';
  static final columnName = 'name';
  static final columnPerRate = 'perRate';
  ...
  immediateConnectDatabase._privateConstructor();
  static final immediateConnectDatabase instance = immediateConnectDatabase._privateConstructor();
