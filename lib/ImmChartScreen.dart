...
class ImmChartScreen extends StatefulWidget{
  double? cryptoCoin;
  String name;
  double? rate;
  String? perRate;
  ...
  ImmChartScreen(this.cryptoCoin, this.name, this.rate, this.perRate, this.cap,this.volume,this.differRate,{super.key});


  @override
  State<ImmChartScreen> createState() => _ImmChartScreenState();
}
class _ImmChartScreenState extends State<ImmChartScreen> {
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text("\$${totalCoin.toStringAsFixed(2)} ${widget.name}", style: GoogleFonts.inter(textStyle:TextStyle(
                                    ...
                                    Row(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      children: [
                                        Text("${widget.cryptoCoin}", style: GoogleFonts.inter(textStyle:TextStyle(
